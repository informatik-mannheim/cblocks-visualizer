...
export const addSensor = (sensor, instanceID) => {
  return { type: Constants.Actions.ADD_SENSOR, sensor, instanceID };
};
...
export const fetchSensorHasErrored = bool => ({
  type: Constants.Actions.FETCH_SENSOR_HAS_ERRORED,
  hasErrored: bool
});

export const fetchSensorIsLoading = bool => ({
  type: Constants.Actions.FETCH_SENSOR_IS_LOADING,
  isLoading: bool
});
